...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { Note_id: @move.Note_id, all: @move.all, player: @move.player, take: @move.take }
    end
  ...
  test "should update move" do
    put :update, id: @move, move: { Note_id: @move.Note_id, all: @move.all, player: @move.player, take: @move.take }
    assert_redirected_to move_path(assigns(:move))
  end
